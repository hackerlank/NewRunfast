...
PlayerInterface * PlayerInterface::CreateRobot( uid_type mid,
                                             boost::function<void (PlayerInterface * player, boost::shared_ptr< assistx2::Stream > packet,
                                                                   RoomInterface * room, time_t delay) > send_callback,
