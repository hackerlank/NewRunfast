...
PlayerBase::PlayerBase( uid_type mid, std::int32_t type ) :obj_(GameObj::GetInstance()),
...
int32_t PlayerBase::OnMessage(boost::shared_ptr<assistx2::Stream> packet)
{
...
int32_t PlayerBase::PlayCost(PlayerInterface *player, int32_t cost, bool isPayByOther, int32_t &proxy_mid)
{
    ...
    else
    {
        ...
        proxy_mid = assistx2::atoi_s(data);
